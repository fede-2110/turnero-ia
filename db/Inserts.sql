...
INSERT INTO CentroAtencion (nombre_centro, direccion, telefono) VALUES
...
INSERT INTO MedicoEspecialidad (medico_id, especialidad_id) VALUES
(1, 1),
(2, 2);

-- Relación Médicos-Centros
INSERT INTO MedicoCentro (medico_id, centro_id) VALUES
(1, 1),
(2, 2);

-- Insertar Horarios de Atención
INSERT INTO HorarioAtencion (medico_id, centro_id, dia_semana, hora_inicio, hora_fin) VALUES
